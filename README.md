...
- `exercises/` - Course exercises and practice projects.
- `exercises/Methods/` - Method-focused C# exercises.
- `exercises/ClassAndObjects/` - Object-oriented programming exercises.
- `exercises/Enum/` - Enum exercises.
...
- HTML
- CSS
- Rider for .net projects / Visual Studio compatible solution and project files
- webstorm for react projects
